...
--------------------
Any pull requests must consist of field-tested parts or design modifications.  In this context, "field-tested" means the part is used on a working printer for a non-trivial duration of time.  Code modifications should follow our published OpenScad Coding Conventions (http://blog.terawattindustries.com/2013/04/20/openscad-coding-conventions/).
...
Use terawatt-prism.scad to model your changes and for (limited) virtual motion testing.  This can help improve the field-testing process.
