...
module part()
{
	translate([20,0.35,0]) rotate([0,0,a]) rail();
	translate([54.60,0.35,0]) rotate([0,0,-a]) mirror([1,0,0]) rail();
	...
	difference()
		{
			...
			{	
				...
				translate([7.5,1,5.9]) cube([5,6.8,2.1]);
				translate([7.5,12.25,5.9]) cube([5,15.5,2.1]);
				translate([7.5,32.3,5.9]) cube([5,7.7,2.1]);
			}
